# docs/glossary.md - Kamus Istilah octo-dashboard
...
- **Apa ini?** Kamus istilah domain proyek octo-dashboard. Tempat rujukan tunggal
...
|-------|---------|--------|-----------|
| 1 | 2026-06-28 | [TBD: <nama>] | Inisialisasi template glossary. |
